...
(function (MetricOption) {
    ...
    MetricOption["NLB_ACTIVE_FLOW_COUNT"] = "ActiveFlowCount";
    MetricOption["NLB_CONSUMED_LCUS"] = "ConsumedLCUs";
    MetricOption["RDS_CPU_UTILIZATION"] = "CPUUtilization";
    MetricOption["RDS_DATABASE_CONNECTIONS"] = "DatabaseConnections";
    MetricOption["RDS_FREE_STORAGE_SPACE"] = "FreeStorageSpace";
    MetricOption["ECS_CPU_UTILIZATION"] = "CPUUtilization";
    MetricOption["ECS_MEMORY_UTILIZATION"] = "MemoryUtilization";
